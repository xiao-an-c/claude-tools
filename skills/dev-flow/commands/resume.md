...
| ACCEPTANCE.md 已存在 | 已完成 | 提示 git-flow finish |
...
- fix 模式 → `workflows/fix.md`（Skill Base directory）
- feat 模式 → `workflows/feat.md`（Skill Base directory）
- refactor 模式 → `workflows/refactor.md`（Skill Base directory）
- hotfix 模式 → `workflows/hotfix.md`（Skill Base directory）
